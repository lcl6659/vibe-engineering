This PR is automatically generated by the AI implementation script following Vibe Engineering principles.
...
- scripts/generated.py (create - minimal example)
...
## Vibe Engineering Notes

- Code changes follow AGENT_PROTOCOL.md
- Tests and documentation are included for both humans and future AI agents
- Changes are minimal, focused, and reviewable
